...
int main()
{
    cout << BBLUE << "Добро пожаловать!" << endl
         ...
         << BYELLOW << "Необходимо разложить функцию Y(x) из" << BRED << " 15 " << BYELLOW <<"варианта в ряд S(x), затем с помощью полученного ряда найти значение функции и сравнить его со значением, вычисленным с помощью стандартных функций. " << RESET << endl
