...
void sum()
{
    ...
    cout << "Введите " << n << " слов(-а) на английском: ";
    for(int i =0; i < n; i++)
    {
        cin.getline(str[i], m);
    }
...
int main()
{
    cout << BBLUE << "Добро пожаловать!" << endl
         ...
         << BYELLOW << "Ввести матрицу. Элементы матрицы – строки. Подсчитать сумму кодов символов каждого слова и, если сумма оказалась четной, развернуть зеркально это слово в строке. " << RESET << endl
