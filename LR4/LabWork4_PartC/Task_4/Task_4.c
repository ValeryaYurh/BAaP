...
int main() {
    ...
    printf("Вариант 15\n");
    printf(BYELLOW "В данном проекте нужно инициализировать при объявлении статический двумерный массив целых чисел размером MxN. Подсчитать сумму четных элементов и произведение нечётных элементов матрицы и вывести на экран исходные данные и полученный результат.\n" RESET);
